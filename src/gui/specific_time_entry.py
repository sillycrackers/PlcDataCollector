...
class SpecificTimeEntry:
    def __init__(self, parent, hour_text_variable,minute_text_variable, row):
        ...
        self.hour_spinbox = ttk.Spinbox(master=self.frame,width=2,font="calibri 12", increment=1, from_=0, to=23, textvariable=self.hour_text_variable)
        ...
        self.minute_spinbox = ttk.Spinbox(master=self.frame,width=2,font="calibri 12", increment=1, from_=0, to=60, textvariable=self.minute_text_variable)
